...
export default async function Intro({ lang }: { lang: LanguagesKeysType }) {
    ...
    return (
        <section className="pt-[4rem] pb-[3.7rem] flex justify-between gap-x-2 items-center">
            ...
            <div className="flex gap-x-2 items-center">
                ...
                <div className="relative w-56 h-56 ">
                    <Image className="object-cover border-2 border-white object-top rounded-[50%]" fill src={"/assets/developer.jpg"} alt="developer image" />
                </div>
